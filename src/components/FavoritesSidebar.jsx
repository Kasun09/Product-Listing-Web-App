...
const FavoritesSidebar = () => {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex justify-end">
            ...
            {/* Sidebar */}
            <div className="relative w-full max-w-md h-full bg-white dark:bg-slate-900 shadow-2xl p-6 flex flex-col transition-transform animate-slide-in-right">
                ...
                <div className="flex-1 overflow-y-auto pr-2 space-y-4 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700">
                    {loading ? (
                        ...
                        products.map(product => (
                            <div key={product.id} className="flex gap-4 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700 group">
