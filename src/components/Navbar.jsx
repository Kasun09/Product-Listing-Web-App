...
const Navbar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full backdrop-blur-lg bg-blue-500/70 dark:bg-gray-400/70 border-b border-blue-200 dark:border-gray-800 transition-colors duration-300">
