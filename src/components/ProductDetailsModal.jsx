                ...
                <div className="w-full md:w-1/2 bg-slate-50 dark:bg-slate-800/50 p-8 flex items-center justify-center relative">
                    ...
                    {product.recommended && (
                        <motion.span
                            ...
                            className="absolute top-6 left-6 bg-amber-400 text-black text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-sm"
                        >
                            ⭐ Recommended
                        </motion.span>
                    )}
                ...
                <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col overflow-y-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-8 pt-8 border-t border-slate-100 dark:border-slate-800">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="flex-1 bg-slate-900 dark:bg-indigo-600 text-white font-bold py-4 rounded-xl hover:bg-slate-800 dark:hover:bg-indigo-500 transition-colors flex items-center justify-center gap-2 shadow-lg hover:shadow-xl duration-200"
                        >
