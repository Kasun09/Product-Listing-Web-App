...
const ProductDetailsModal = ({ product, onClose, isFavorite, toggleFavorite }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className="relative w-full max-w-4xl bg-blue-200 dark:bg-slate-600 rounded-3xl shadow-2xl overflow-hidden animate-scale-up flex flex-col md:flex-row max-h-[90vh]">
