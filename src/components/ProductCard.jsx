...
const ProductCard = ({ product, isFavorite, toggleFavorite, viewMode = 'grid', onViewDetails }) => {
    ...
    return (
        <div className={`group relative bg-blue-200 dark:bg-slate-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-800 dark:border-slate-200 overflow-hidden ${isList ? 'flex flex-row items-center p-4 gap-6' : 'flex flex-col'
            }`}>
